...
public class Skill_Arrow : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        Manager.instance.manager_SE.seAudio.PlayOneShot(
            Manager.instance.manager_SE.flying_SoulArrow);
    ...
    {
        hitEffect = Manager.instance.manager_Obj.GetObj(
            Manager.instance.manager_Obj.list_hitEffect);
        hitEffect.transform.position = hitPoint + new Vector3(0, 1, 0);
        hitEffect.SetActive(true);
    }
    void CalculateDmg()
    {
        PlayerState playerState = Manager.instance.playerController.player.
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            Manager.instance.manager_SE.seAudio.PlayOneShot(
            Manager.instance.manager_SE.hit_SoulArrow);
            ...
            CalculateDmg();
            GameObject dmgText = Manager.instance.manager_Obj.
                GetObj(Manager.instance.manager_Obj.list_dmgText);

            dmgText.GetComponent<TextMeshProUGUI>().text = dmg.ToString();
            dmgText.GetComponent<TextMeshProUGUI>().fontSize =
                50 * dmgRate;
            dmgText.transform.position = Manager.instance.playerController.
                cam.WorldToScreenPoint(hitPoint + new Vector3(0, 1, 0));
